...
class IntegrationTests(unittest.TestCase):
    ...
    def test_integration1(self):
        ...
        self.compare_csvs("fixtures/cycle_data.csv", 'itest1_cycle_data.csv')
        self.model.export_raw_data_csv('itest1_raw_data.csv')
        self.compare_csvs("fixtures/raw_data.csv", 'itest1_raw_data.csv')
        self.model.export_corrected_data_csv('itest1_corrected_data.csv')
        self.compare_csvs("fixtures/corrected_data.csv", 'itest1_corrected_data.csv')
        self.model.export_analytical_conditions_csv('itest1_analytical_conditions.csv')
        self.compare_csvs("fixtures/analytical_data.csv", 'itest1_analytical_conditions.csv')
